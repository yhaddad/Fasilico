#ifndef TrackSmearer_h
#define TrackSmearer_h 1
 ...
 *
 *  @author F. Gaede, DESY
 *  @version $Id: TrackSmearer.h,v 1.2 2005-10-11 12:56:28 gaede Exp $ 
 */
...
class TrackSmearer : public FourVectorSmearer {
  
  typedef std::vector<TrackResolution> ResVec ;
  
 public:
    
  TrackSmearer(const std::vector<float>& resVec ) ;
